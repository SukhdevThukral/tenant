...
export const boot : {
    ...
    {text : "Building Management System v2.2.1 [i386]", delay:300},
    {text : "", delay:400},
    {text : "Loading subsystems...", delay:800},
    {text : "   sensor array                11 zones        [OK]", delay:700},
    {text : "   camera feeds                11 / 11         [OK]", delay:600},
    {text : "   electromagnetic locks                       [OK]", delay:600},
    {text : "   motion grid                                 [OK]", delay:600},
    {text : "   emergency protocol          ARMED           [OK]", delay:700},
    {text : "", delay:600},
    {text : "   Shift log started      03:47:01", delay:500},
    {text : "   Operator: MAINT-7      Station: Basement", delay:400},
    {text : "", delay:600},
    {text : "   ————————————————————————————————————————————————————————————————", delay:0},
    {text : "", delay:400},
    {text : "   [03:47:04]    Passive sweep complete. Clear.", delay:900},
    {text : "   [03:47:11]    Roof sensor: single read.", delay:1800},
    {text : "                 Source unknown. Logging.", delay:800},
    {text : "                Flagged wildlife. Auto-reset.", delay:900},
    {text : "", delay:1200},
    {text : "   [03:47:29]    Roof sensor: reading again.", delay:1000},
    {text : "                 Weight estimate: 190kg+.", delay:800},
    {text : "                 No wildlife on record that heavy..", delay:900},
    {text : "", delay:1000},
    {text : "   ————————————————————————————————————————————————————————————————", delay:0},
    {text : "", delay:600},
    {text : `   Type HELP for command list.`, delay:400},
    {text : "", delay:200},
];
